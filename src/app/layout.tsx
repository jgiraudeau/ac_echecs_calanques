...
export const metadata: Metadata = {
  title: "Académie d'Échecs des Calanques | Club d'échecs Enfants & Adultes (13)",
  description: "Vous cherchez un club d'échecs, un stage pour enfants ou une activité pour enfants dès 6 ans proche de chez vous ? L'Académie d'Échecs des Calanques vous accueille à Cassis, Carnoux, La Ciotat, Ceyreste et Marseille.",
  keywords: [
    "club d'échecs",
  ...
  openGraph: {
    title: "Académie d'Échecs des Calanques | Club d'échecs (13)",
    description: "Rejoignez votre club d'échecs de référence proche de chez vous dans les Calanques : Cassis, Carnoux, La Ciotat, Ceyreste et Marseille.",
...
const jsonLdData = {
  ...
  "description": "Club d'échecs d'excellence pour enfants et adultes dans les Bouches-du-Rhône (13). Cours hebdomadaires, tournois, stages pour enfants et activité pour enfants dès 6 ans proche de chez vous à Cassis, Carnoux, La Ciotat, Ceyreste et Marseille.",
  "url": "https://www.echecs-calanques.fr",
